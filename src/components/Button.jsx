...
const Button = ({ children, type }) => {
  if (type === "loginBtn") {
    ...
    return (
      <button className="w-[100%] md:w-[40%] bg-cyan-800 hover:bg-cyan-900 focus:outline-none focus:shadow-lg text-lg text-white font-medium font-heading py-[14px] px-[50px] rounded-md disabled:bg-opacity-75 disabled:cursor-not-allowed">
        {children}
      </button>
    );
  }
