...
export default function ManageCoupons() {
  ...
  //get coupons
  const { coupons, loading, error, isDeleted } = useSelector(
    (state) => state?.coupons
  );
  ...
  return (
    <>
      {isDeleted && <SuccessMsg message="Coupon deleted successfully" />}

      <div className="px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <h2 className="text-xl font-semibold text-white capitalize">
              Coupons List - ({coupons?.coupons?.length})
            </h2>
                    ...
                    <table className="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody className="divide-y divide-gray-200 bg-light-blue">
                        {coupons?.coupons?.map((coupon) => (
                          <tr key={coupon?._id}>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6 text-white">
                              {coupon?.code}
                            </td>
